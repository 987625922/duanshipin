...
import com.ljf.duanshipin.common.dto.VerifyCodeDto;
import com.ljf.duanshipin.common.exception.AllException;
import com.ljf.duanshipin.common.exception.StatusEnum;
import com.ljf.duanshipin.common.utils.RedisTemplateUtil;
import com.ljf.duanshipin.config.DuanshipinConstant;
import com.ljf.duanshipin.domain.ImageType;
import com.ljf.duanshipin.domain.ValidateCodeProperties;
...
public class ValidateCodeService {
    ...
    public VerifyCodeDto create() {
        ...
        //保存验证码
        redisService.set(DuanshipinConstant.CODE_PREFIX + key,
    ...
    public void check(String key, String value) {
        //从redis中获取验证码
        Object codeInRedis = redisService.get(DuanshipinConstant.CODE_PREFIX + key);
        //判断输入的验证码是否为空
