...
import com.ljf.duanshipin.config.DuanshipinProperties;
...
/**
 * @Author: LL
 * @Description: shiro的springboot的config
 * @Date:Create：in 2020/9/18 15:49
 */
@Configuration
public class ShiroConfig {

    @Autowired
    private DuanshipinProperties duanshipinProperties;
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        // 设置免认证 url
        String[] anonUrls = StringUtils.splitByWholeSeparatorPreserveAllTokens(duanshipinProperties.getShiro().getAnonUrl(), ",");
