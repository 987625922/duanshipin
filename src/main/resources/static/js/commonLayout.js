...
function writeLeft() {
    ...
    document.writeln("                            <a href=\'../customer/videoReport.html\'>");
    document.writeln("                                <i id=\'left_item_five_img\'>");
    document.writeln("                                </i>");
    document.writeln("                                <span>客服系统</span>");
    document.writeln("                            </a>");
    document.writeln("                        </div>");
    document.writeln("                        <div class=\'left_item left_item_seven\'>");
    document.writeln("                            <a href=\'../system/adminManage.html\'>");
    document.writeln("                                <i id=\'left_item_seven_img\'>");
    document.writeln("                                </i>");
